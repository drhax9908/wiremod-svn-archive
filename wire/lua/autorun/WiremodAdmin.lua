...
if ( CLIENT ) then
	function WiremodAdmin.CreateWiremodAdminMenu()
		spawnmenu.AddContext("Utilities", "WiremodControlPanel", "Wiremod Control Panel", "Wiremod Control Panel")
		
		local Panel = GetControlPanel( "WiremodControlPanel" )
	...
	WiremodAdmin.CreateWiremodAdminMenu()
end
