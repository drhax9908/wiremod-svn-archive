...
function TOOL:LeftClick( trace )
	...
	local wire_socket = MakeWireSocket( ply, Pos, Ang, a, ar, ag, ab, aa )
	...
	if (trace.HitWorld) then
		 local socket_phys = wire_socket:GetPhysicsObject()
	else
		trace.Entity:DeleteOnRemove( wire_socket )
	...
	ply:AddCleanup( "wire_sockets", nocollide )
...
function TOOL:RightClick( trace )
	...
	local wire_plug = MakeWirePlug( ply, trace.HitPos, Ang, a, ar, ag, ab, aa )
	...
	ply:AddCleanup( "wire_plugs", nocollide )
...
if (SERVER) then
	...
	function MakeWirePlug( pl, Pos, Ang, a, ar, ag, ab, aa )
		...
		wire_plug:SetModel( Model("models/props_lab/tpplug.mdl") )
		wire_plug:Spawn()
	...
	duplicator.RegisterEntityClass("gmod_wire_plug", MakeWirePlug, "Pos", "Ang", "a", "ar", "ag", "ab", "aa")
	...
	function MakeWireSocket( pl, Pos, Ang, a, ar, ag, ab, aa )
		...
		wire_socket:SetModel( Model("models/props_lab/tpplugholder_single.mdl") )
		wire_socket:Spawn()
	...
	duplicator.RegisterEntityClass("gmod_wire_socket", MakeWireSocket, "Pos", "Ang", "a", "ar", "ag", "ab", "aa")
