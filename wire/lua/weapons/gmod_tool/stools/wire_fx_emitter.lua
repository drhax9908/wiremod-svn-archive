...
function TOOL:LeftClick( trace )
	...
	local wire_fx_emitter = MakeWireFXEmitter( ply, trace.HitPos, ang, delay, effect )
...
if (SERVER) then
	...
	function MakeWireFXEmitter( ply, Pos, Ang, delay, effect, Vel, aVel, frozen, nocollide )
