...
function TOOL:LeftClick( trace )
	...
	wire_datarate = MakeWiredatarate( ply, Ang, trace.HitPos, Smodel )
...
if (SERVER) then
	...
	function MakeWiredatarate( pl, Ang, Pos, Smodel )
	...
	duplicator.RegisterEntityClass("gmod_wire_datarate", MakeWiredatarate, "Ang", "Pos", "Smodel")
