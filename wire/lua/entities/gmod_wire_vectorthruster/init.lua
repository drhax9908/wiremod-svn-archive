...
function ENT:SpawnFunction( ply, tr )
	...
	self.Entity:SetModel( "models/jaanus/wiretool/wiretool_speed.mdl" )
	ent:SetPos( SpawnPos )
	ent:SetPlayer( ply )
	ent:Spawn()
	ent:Activate()
...
function ENT:Setup(force, force_min, force_max, oweffect, uweffect, owater, uwater, bidir, sound, mode, angle)
	self:SetForce(force)
