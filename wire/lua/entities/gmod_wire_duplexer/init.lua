//Based on SatriAli  Multiple datatype support ents
AddCSLuaFile( "cl_init.lua" )
AddCSLuaFile( "shared.lua" )

include('shared.lua')

ENT.WireDebugName = "Duplexer Chip"
ENT.OverlayDelay = 0
...
function MakeWireDuplexer(pl, Pos, Ang, Model, action, noclip, Vel, aVel, frozen, nocollide)
	if ( !pl:CheckLimit( "wire_gates" ) ) then return nil end

	local wire_gate = ents.Create( "gmod_wire_duplexer" )
...
duplicator.RegisterEntityClass("gmod_wire_duplexer", MakeWireDuplexer, "Pos", "Ang", "Model", "action", "noclip", "Vel", "aVel", "frozen")
