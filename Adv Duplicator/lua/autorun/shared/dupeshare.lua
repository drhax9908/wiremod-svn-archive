...
function dupeshare.Compress(str, ForConCommand)
	...
	if (ForConCommand) then //ÑÖàâäãåçéèêëíìîïñóòôöõúùûü†°¢£§•¶ß®©™ unused special chars
		str = string.gsub(string.gsub(string.gsub(str,"É","|É"),"Ü","|Ü"),"á","|á") //incase it has any of these...
...
function dupeshare.DeCompress(str, FormConCommand)
	...
	if (FormConCommand) then
		str = string.gsub(string.gsub(string.gsub(str,"|É","É"),"|Ü","Ü"),"|á","á")
		str = string.gsub(string.gsub(string.gsub(str,"É","\n"),"Ü","\t"),"á","\"")
	end
